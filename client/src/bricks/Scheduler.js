                ...
                switch (response.status) {
                    case 200: {
                        ...
                        const _events = responseJson.map((r) => ({
                            ...
                            color:
                                r.end_date < startDate ? "#A7C7E7" : getEventColor(r.state_id),
                        }));
                        setEvents(_events);
                        break;
                    }
        ...
        ReservationService.postReservation(values).then(async (response) => {
            ...
            if (response.ok) {
                ...
                toast.current.show({
                    severity: "success",
                    summary: "Success",
                    detail: `Rezervation ${responseJson.id} was created`,
                    life: 3000,
                });
            } else {
                console.log(response);
                    ...
                    >
                        <Formik
                            ...
                            validationSchema={Yup.object({
                                ...
                                room_id: Yup.number().required("Required field"),
                            })}
